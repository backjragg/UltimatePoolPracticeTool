...
/**
 *
 * CueBall Class for the CueBall object
 *
 */
...
public class CueBall {
	...
	/**
	 *
	 * shootCue function that shoots the cue ball when the mouse is dragged back.
	 * @param xPos variable used for the X position of the ball.
	 * @param yPos variable used for the Y position of the ball.
	 */
	...
	private void shootCue(double xPos, double yPos) {
		...
		else
		{
			...
			else
			{
				...
				{
					//path.setPath(lines.get(i));
					//path.setDuration(Duration.millis(1000*i));
	...
	private Point2D getIntersection(Line line, int hitVal)
	{
		...
		//System.out.println("y collides at: " + y);
		//System.out.println("x collides at: " + x);
